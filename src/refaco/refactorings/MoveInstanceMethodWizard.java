...
public final class MoveInstanceMethodWizard extends RefactoringWizard {
	...
	public final class MoveInstanceMethodPage extends UserInputWizardPage {
		...
		public void createControl(final Composite parent) {
			...
			viewer.setSelection(new StructuredSelection(new Object[] { target}));
	...
	private IVariableBinding target;
	 ...
	 */
	public MoveInstanceMethodWizard(MoveInstanceMethodProcessor processor, Refactoring refactoring, IVariableBinding target) {
